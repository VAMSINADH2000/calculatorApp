...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        self.user_input = Entry(self, bg = "#ffc266", bd = 29,
        ...
        self.Clearbutton = Button(self, bg = "#80ff80", bd = 12,
